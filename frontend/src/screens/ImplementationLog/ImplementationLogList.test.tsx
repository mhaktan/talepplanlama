...
import { ImplementationLogList } from './ImplementationLogList';
...
describe('ImplementationLogList', () => {
  it('should render without crashing', () => {
    const { container } = render(<ImplementationLogList />, { wrapper });
    expect(container).toBeDefined();
  });

  it('should show title', () => {
    render(<ImplementationLogList />, { wrapper });
    expect(screen.getByText('ImplementationLog')).toBeDefined();
  });

  it('should have create button', () => {
    render(<ImplementationLogList />, { wrapper });
    expect(screen.getByText('+ Create ImplementationLog')).toBeDefined();
  });
