...
describe('RequestTypeList', () => {
  it('should render without crashing', () => {
    const { container } = render(<RequestTypeList />, { wrapper });
    expect(container).toBeDefined();
  });

  it('should show title', () => {
    render(<RequestTypeList />, { wrapper });
    expect(screen.getByText('RequestType')).toBeDefined();
  });

  it('should have create button', () => {
    render(<RequestTypeList />, { wrapper });
    expect(screen.getByText('+ Create RequestType')).toBeDefined();
  });
