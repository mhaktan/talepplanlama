...
namespace talepplanlama.ImplementationLogs.Dto
{
    ...
    public class ImplementationLogGroupedCountInput : PagedImplementationLogResultRequestDto
    {
        public string GroupBy { get; set; }
    }

    public class ImplementationLogStatsInput : PagedImplementationLogResultRequestDto
    {
